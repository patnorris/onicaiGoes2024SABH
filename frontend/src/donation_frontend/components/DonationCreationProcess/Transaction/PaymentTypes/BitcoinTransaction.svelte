<script lang="ts">
  ...
  $: recipientWalletAddress = $currentDonationCreationObject.recipient.recipientWalletAddresses.BTC;
  $: peerToPeerPayment = $currentDonationCreationObject.donation.peerToPeerPayment;
...
{#if peerToPeerPayment}
  {#if recipientWalletAddress}
    <p>Recipient's BTC address: {recipientWalletAddress}</p>
  {:else}
