  ...
  <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
    <div class="sm:flex sm:items-center sm:justify-between">
      ...
      <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
        ...
        <li>
          <a href="#/explore" class="mr-4 hover:underline md:mr-6 ">Donations</a>
        </li>
        <li>
          <a href="#/recipients" class="mr-4 hover:underline md:mr-6">Recipients</a>
        </li>
        <li>
    ...
    <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400"><p>Powered by <a href='https://internetcomputer.org/' target='_blank' rel="noreferrer" class='underline'>Internet Computer</a></span>
  </div>
</footer>
